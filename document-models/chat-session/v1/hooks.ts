...
import type { ChatSessionAction, ChatSessionDocument } from 'document-models/chat-session/v1';
import { assertIsChatSessionDocument, isChatSessionDocument } from './gen/document-schema.js';

/** Hook to get a ChatSession document by its id */
export function useChatSessionDocumentById(documentId: string | null | undefined): [ChatSessionDocument, DocumentDispatch<ChatSessionAction>] | [undefined, undefined] {
...
export function useSelectedChatSessionDocument(): [ChatSessionDocument, DocumentDispatch<ChatSessionAction>] {
