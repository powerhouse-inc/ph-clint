...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      // we need to cascade the text inherit to the children so that the different styles
      // for the user vs assistant are applied to them as well
      'flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden text-sm **:text-inherit',
