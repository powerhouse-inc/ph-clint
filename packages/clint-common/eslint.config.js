...
const typescriptEsLintRecommendedConfig = [...tseslint.configs.recommendedTypeChecked];

/** Main config */
export default defineConfig(ignored, eslintRecommendedConfig, typescriptEsLintRecommendedConfig, typescriptConfig, reactConfig, javascriptConfig, eslintPluginPrettierRecommended);
