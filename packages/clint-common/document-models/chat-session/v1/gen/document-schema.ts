...
export function isChatSessionState(state: unknown): state is ChatSessionPHState {
...
export function assertIsChatSessionState(state: unknown): asserts state is ChatSessionPHState {
  ChatSessionPHStateSchema.parse(state);
}

/** Simple helper function to check if a document is a ChatSession document */
export function isChatSessionDocument(document: unknown): document is ChatSessionDocument {
...
export function assertIsChatSessionDocument(document: unknown): asserts document is ChatSessionDocument {
