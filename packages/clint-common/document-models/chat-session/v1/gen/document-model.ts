  ...
  specifications: [
    {
      state: {
        ...
        global: {
          ...
          examples: [],
          initialValue:
            '{"threadId": null, "resourceId": null, "agent": null, "status": "ACTIVE", "startedAt": null, "endedAt": null, "messages": [], "usage": null, "interruptRequested": false}',
        },
      },
      modules: [
        {
          ...
          name: "system",
          description:
            "Session lifecycle and framework-level operations. Controlled by the system/admin actor.",
          operations: [
            {
              id: "op-start-session",
              name: "START_SESSION",
              description:
                "Initialize a chat session with thread ID, resource ID, agent info, and start timestamp. Sets status to ACTIVE.",
              schema:
            ...
            },
            {
              ...
              name: "SET_AGENT_INFO",
              description:
                "Update agent configuration (id, name, model, instructions).",
              schema:
        ...
        },
        {
          ...
          name: "user",
          description:
            "Human user operations: sending messages, deleting own messages, aborting the session.",
          operations: [
            {
              ...
              errors: [
                {
                  ...
                  description:
                    "The specified message ID does not exist in the session.",
                  template: "",
                },
                {
                  id: "err-not-user-msg",
                  ...
                  description:
                    "Only messages with role USER can be deleted via this operation.",
                  template: "",
                },
              ],
              examples: [],
            ...
            },
            {
              ...
              name: "ABORT_SESSION",
              description:
                "User-initiated session abort. Sets status to ABORTED with end timestamp.",
            ...
            },
            {
              ...
              description:
                "User-initiated interrupt of the in-flight agent turn. Sets interruptRequested so the agent watcher aborts the current stream. The session stays ACTIVE so the user can keep chatting.",
        ...
        },
        {
          ...
          name: "agent",
          description:
            "LLM/assistant operations: adding responses, streaming content parts, recording token usage.",
          operations: [
            {
            ...
            },
            {
              ...
              description:
                "Update an existing content part within an assistant message. Used to accumulate streamed text deltas.",
              schema:
              ...
              errors: [
                ...
                },
                {
                  ...
                  description:
                    "The specified content part ID does not exist in the message.",
                  template: "",
                },
              ],
              examples: [],
        ...
        },
        {
          ...
          name: "tool",
          description:
            "Tool executor operations: returning tool results and progressive output.",
          operations: [
            {
            ...
            },
            {
              ...
              description:
                "Add progressive output from a running tool. Appends a TEXT content part to an existing tool message.",
              schema:
