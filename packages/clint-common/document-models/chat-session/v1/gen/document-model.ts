  ...
  specifications: [
    {
      state: {
        ...
        global: {
          ...
          examples: [],
          initialValue: '{"threadId": null, "resourceId": null, "agent": null, "status": "ACTIVE", "startedAt": null, "endedAt": null, "messages": [], "usage": null, "interruptRequested": false, "responding": false}',
        },
      },
      modules: [
        {
          ...
          operations: [
            ...
            {
              id: 'op-set-agent-description',
              name: 'SET_AGENT_DESCRIPTION',
              description: 'Set or update the agent description text.',
              schema: 'input SetAgentDescriptionInput {\n  description: String!\n}',
              template: 'Set or update the agent description text.',
        ...
        },
        {
          ...
          operations: [
              ...
              errors: [
                {
                  ...
                  description: 'A content part is missing required fields for its type (e.g. TEXT without text).',
                  template: '',
                },
              ],
              examples: [],
            ...
            {
              id: 'op-interrupt-agent',
              name: 'INTERRUPT_AGENT',
              description: 'User-initiated interrupt of the in-flight agent turn. Sets interruptRequested so the agent watcher aborts the current stream. The session stays ACTIVE so the user can keep chatting.',
              schema: 'input InterruptAgentInput {\n  _: Boolean\n}',
              template: 'User-initiated interrupt of the in-flight agent turn. Sets interruptRequested so the agent watcher aborts the current stream. The session stays ACTIVE so the user can keep chatting.',
              reducer: 'state.interruptRequested = true;',
              errors: [],
              examples: [],
              scope: 'global',
            },
        ...
        },
        {
          ...
          operations: [
              ...
              errors: [
                {
                  ...
                  name: 'InvalidContentPartError',
                  code: 'INVALID_CONTENT_PART',
                  description: 'A content part is missing required fields for its type (e.g. TEXT without text, TOOL_CALL without toolCallId).',
                  template: '',
                },
              ],
              examples: [],
            ...
            {
              id: 'op-set-responding',
              name: 'SET_RESPONDING',
              description: 'Mark whether the agent is actively generating a response. The agent runner sets this true while streaming a turn and false when the turn ends or is interrupted, so clients can show a stop control.',
              schema: 'input SetRespondingInput {\n  responding: Boolean!\n}',
              template: 'Mark whether the agent is actively generating a response. The agent runner sets this true while streaming a turn and false when the turn ends or is interrupted, so clients can show a stop control.',
              reducer: 'state.responding = action.input.responding;',
              errors: [],
              examples: [],
              scope: 'global',
            },
