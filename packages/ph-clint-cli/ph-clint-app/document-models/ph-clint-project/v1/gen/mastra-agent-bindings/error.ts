export type ErrorCode = 'MastraNotEnabledError' | 'AgentNotFoundError' | 'ModelReferenceNotFoundError' | 'ProfileReferenceNotFoundError' | 'InvalidSkillNameError' | 'SkillNotFoundError' | 'InvalidToolPatternError' | 'ToolPatternNotFoundError';
...
export class ProfileReferenceNotFoundError extends Error implements ReducerError {
