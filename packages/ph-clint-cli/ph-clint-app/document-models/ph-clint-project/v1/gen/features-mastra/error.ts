export type ErrorCode = 'InvalidAgentIdError' | 'InvalidAgentNameError' | 'MastraNotEnabledError' | 'InvalidModelIdError' | 'DuplicateModelError' | 'ModelNotFoundError' | 'InvalidProfileIdError' | 'DuplicateProfileError' | 'ProfileNotFoundError';
