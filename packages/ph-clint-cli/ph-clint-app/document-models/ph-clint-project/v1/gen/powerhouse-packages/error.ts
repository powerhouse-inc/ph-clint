export type ErrorCode = 'DuplicatePackageError' | 'PackageNotFoundError' | 'CannotRemoveAppPackageError' | 'InvalidDocumentTypeError' | 'DuplicateDocumentTypeError' | 'DocumentTypeNotFoundError';
