...
export const setMainAgentName = (input: SetMainAgentNameInput) =>
  createAction<SetMainAgentNameAction>(
    "SET_MAIN_AGENT_NAME",
    { ...input },
    undefined,
    SetMainAgentNameInputSchema,
...
export const setMainAgentDescription = (input: SetMainAgentDescriptionInput) =>
  createAction<SetMainAgentDescriptionAction>(
...
export const clearMainAgentDescription = (
  input: ClearMainAgentDescriptionInput,
) =>
  createAction<ClearMainAgentDescriptionAction>(
...
export const setMainAgentImage = (input: SetMainAgentImageInput) =>
  createAction<SetMainAgentImageAction>(
...
export const clearMainAgentImage = (input: ClearMainAgentImageInput) =>
  createAction<ClearMainAgentImageAction>(
