...
const stateReducer: StateReducer<PhClintProjectPHState> = (
  ...
  switch (action.type) {
    ...
    case "SET_PACKAGE_IDENTIFIER": {
      ...
      phClintProjectIdentityOperations.setPackageIdentifierOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_POWERHOUSE_LEVEL": {
      ...
      phClintProjectFeaturesPowerhouseOperations.setPowerhouseLevelOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_POWERHOUSE_PACKAGE": {
      ...
      phClintProjectPowerhousePackagesOperations.addPowerhousePackageOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_POWERHOUSE_PACKAGE": {
      ...
      phClintProjectPowerhousePackagesOperations.removePowerhousePackageOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_PACKAGE_DOCUMENT_TYPE": {
      ...
      phClintProjectPowerhousePackagesOperations.addPackageDocumentTypeOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_EXTERNAL_SKILL": {
      ...
      phClintProjectExternalSkillsOperations.addExternalSkillOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_EXTERNAL_SKILL": {
      ...
      phClintProjectExternalSkillsOperations.removeExternalSkillOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_EXTERNAL_SKILL_NAME": {
      ...
      phClintProjectExternalSkillsOperations.setExternalSkillNameOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_EXTERNAL_SKILL_GITHUB_URL": {
      ...
      phClintProjectExternalSkillsOperations.setExternalSkillGithubUrlOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "BUMP_VERSION": {
      ...
      phClintProjectPublishingOperations.bumpVersionOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "PUBLISH_DEV": {
      ...
      phClintProjectPublishingOperations.publishDevOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "PUBLISH_STAGING": {
      ...
      phClintProjectPublishingOperations.publishStagingOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "PUBLISH_PRODUCTION": {
      ...
      phClintProjectPublishingOperations.publishProductionOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_PUBLISH_STATUS": {
      ...
      phClintProjectPublishingOperations.setPublishStatusOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "IMPORT_SPEC": {
      ...
      phClintProjectLifecycleOperations.importSpecOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_SUPPORTED_RESOURCE": {
      ...
      phClintProjectDeploymentOperations.addSupportedResourceOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_SUPPORTED_RESOURCE": {
      ...
      phClintProjectDeploymentOperations.removeSupportedResourceOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_PROXY_ENABLED": {
      ...
      phClintProjectDeploymentOperations.setProxyEnabledOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_OBSERVABILITY_ENABLED": {
      ...
      phClintProjectDeploymentOperations.setObservabilityEnabledOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_MODEL": {
      ...
      phClintProjectMastraModelsOperations.addModelOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_PROFILE": {
      ...
      phClintProjectMastraProfilesOperations.addProfileOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "UPDATE_PROFILE": {
      ...
      phClintProjectMastraProfilesOperations.updateProfileOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_PROFILE": {
      ...
      phClintProjectMastraProfilesOperations.removeProfileOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REORDER_PROFILES": {
      ...
      phClintProjectMastraProfilesOperations.reorderProfilesOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_MAIN_AGENT_NAME": {
      ...
      phClintProjectMastraMainAgentOperations.setMainAgentNameOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_MAIN_AGENT_DESCRIPTION": {
      ...
      phClintProjectMastraMainAgentOperations.setMainAgentDescriptionOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "CLEAR_MAIN_AGENT_DESCRIPTION": {
      ...
      phClintProjectMastraMainAgentOperations.clearMainAgentDescriptionOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_MAIN_AGENT_IMAGE": {
      ...
      phClintProjectMastraMainAgentOperations.setMainAgentImageOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "CLEAR_MAIN_AGENT_IMAGE": {
      ...
      phClintProjectMastraMainAgentOperations.clearMainAgentImageOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_SUB_AGENT": {
      ...
      phClintProjectMastraSubAgentsOperations.addSubAgentOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_SUB_AGENT": {
      ...
      phClintProjectMastraSubAgentsOperations.removeSubAgentOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_SUB_AGENT_NAME": {
      ...
      phClintProjectMastraSubAgentsOperations.setSubAgentNameOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_SUB_AGENT_DESCRIPTION": {
      ...
      phClintProjectMastraSubAgentsOperations.setSubAgentDescriptionOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_AGENT_MODEL": {
      ...
      phClintProjectMastraAgentBindingsOperations.setAgentModelOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_AGENT_PROFILE_REF": {
      ...
      phClintProjectMastraAgentBindingsOperations.addAgentProfileRefOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_AGENT_PROFILE_REF": {
      ...
      phClintProjectMastraAgentBindingsOperations.removeAgentProfileRefOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REORDER_AGENT_PROFILE_REFS": {
      ...
      phClintProjectMastraAgentBindingsOperations.reorderAgentProfileRefsOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_AGENT_SKILL": {
      ...
      phClintProjectMastraAgentBindingsOperations.addAgentSkillOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_AGENT_SKILL": {
      ...
      phClintProjectMastraAgentBindingsOperations.removeAgentSkillOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_AGENT_TOOL_PATTERN": {
      ...
      phClintProjectMastraAgentBindingsOperations.addAgentToolPatternOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_AGENT_TOOL_PATTERN": {
      ...
      phClintProjectMastraAgentBindingsOperations.removeAgentToolPatternOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
