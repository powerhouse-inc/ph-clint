...
const stateReducer: StateReducer<PhClintProjectPHState> = (
  ...
  switch (action.type) {
    ...
    case "SET_AGENT_ID": {
      ...
      phClintProjectFeaturesMastraOperations.setAgentIdOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_AGENT_NAME": {
      ...
      phClintProjectFeaturesMastraOperations.setAgentNameOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_MODEL": {
      ...
      phClintProjectFeaturesMastraOperations.addModelOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_MODEL": {
      ...
      phClintProjectFeaturesMastraOperations.removeModelOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_DEFAULT_MODEL": {
      ...
      phClintProjectFeaturesMastraOperations.setDefaultModelOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "ADD_PROFILE": {
      ...
      phClintProjectFeaturesMastraOperations.addProfileOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "UPDATE_PROFILE": {
      ...
      phClintProjectFeaturesMastraOperations.updateProfileOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REMOVE_PROFILE": {
      ...
      phClintProjectFeaturesMastraOperations.removeProfileOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "REORDER_PROFILES": {
      ...
      phClintProjectFeaturesMastraOperations.reorderProfilesOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
    ...
    case "SET_AGENT_DESCRIPTION": {
      ...
      phClintProjectFeaturesMastraOperations.setAgentDescriptionOperation(
        (state as any)[action.scope],
        action as any,
        dispatch,
      );
