  ...
  specifications: [
    {
      ...
      modules: [
        ...
        },
        {
          ...
          description: 'Top-level Mastra feature toggles: enable/disable and chat integration.',
          operations: [
            {
              id: 'o-enable-mastra',
              name: 'ENABLE_MASTRA',
              description: 'Enable Mastra. Seeds mainAgent with a default model (clint/demo-agent) and a base profile. Idempotent.',
              schema: 'input EnableMastraInput {\n  agentId: OID!\n  agentName: String!\n}',
              template: 'Enable the Mastra agent feature. Seeds mainAgent with the seeded model + profile.',
              reducer:
            ...
            },
            {
              id: 'o-disable-mastra',
              name: 'DISABLE_MASTRA',
              description: 'Disable Mastra. Clears mainAgent, subAgents, models, profiles and the chat integration. Removes the auto-managed clint-common package.',
        ...
        },
        {
          id: 'm-mastra-models',
          name: 'mastra_models',
          description: 'Model library CRUD. Models are referenced by main and sub agents via modelId.',
          operations: [
            {
              id: 'o-add-model',
              name: 'ADD_MODEL',
              description: 'Add a model to the library. ID must be provider/model-name format. First model is forced default. If isDefault is true, previous default is unset.',
            ...
            },
            {
              id: 'o-remove-model',
              name: 'REMOVE_MODEL',
              description: 'Remove a model from the library. Rejects when any agent (main or sub) references it. Promotes first remaining to default if removing the current default.',
              ...
              errors: [
                ...
                },
                {
                  ...
                  code: 'MODEL_IN_USE',
                  description: 'Cannot remove a model that is still referenced by an agent.',
                  template: '',
                },
              ],
              examples: [],
        ...
        },
        {
          ...
          description: 'Profile library CRUD. Profiles are referenced by main and sub agents via profileIds.',
          operations: [
            {
              id: 'o-add-profile',
              name: 'ADD_PROFILE',
              description: 'Add a profile to the library. Inserted before insertBefore if provided, otherwise appended.',
            ...
            },
            {
              id: 'o-remove-profile',
              name: 'REMOVE_PROFILE',
              description: 'Remove a profile from the library. Rejects when any agent (main or sub) references it.',
              ...
              errors: [
                ...
                },
                {
                  ...
                  code: 'PROFILE_IN_USE',
                  description: 'Cannot remove a profile that is still referenced by an agent.',
                  template: '',
                },
              ],
              examples: [],
        ...
        },
        {
          ...
          description: 'Main agent identity ops. Main agent ID is set at ENABLE_MASTRA and stable thereafter \u2014 to change it, disable then re-enable.',
          operations: [
            {
              id: 'o-set-main-agent-name',
              name: 'SET_MAIN_AGENT_NAME',
              description: "Set the main agent's display name. Must be non-empty after trim.",
              ...
              errors: [
                {
                  ...
                  name: 'MastraNotEnabledError',
                  code: 'MASTRA_NOT_ENABLED',
                  description: 'Mastra must be enabled before managing the main agent.',
                  template: '',
                },
                {
            ...
            },
            {
              ...
              schema: 'input SetMainAgentDescriptionInput {\n  description: String!\n}',
        ...
        },
        {
          ...
          description: 'Sub-agent CRUD. Sub-agent ids are unique across the main agent and all other sub-agents.',
          operations: [
            {
              id: 'o-add-sub-agent',
              name: 'ADD_SUB_AGENT',
              description: 'Add a sub-agent. ID must be lowercase kebab-case and unique (across main + sub agents). modelId must exist in the model library. Seeds empty profileIds/skills/toolPatterns.',
              schema: 'input AddSubAgentInput {\n  id: OID!\n  name: String!\n  description: String!\n  modelId: OID!\n}',
              ...
              errors: [
                {
                  ...
                  name: 'MastraNotEnabledError',
                  code: 'MASTRA_NOT_ENABLED',
                  description: 'Mastra must be enabled before managing sub-agents.',
                  template: '',
                },
                {
                ...
                },
                {
                  ...
                  name: 'InvalidAgentNameError',
                  code: 'INVALID_AGENT_NAME',
                  description: 'Sub-agent name must not be empty after trimming.',
                  template: '',
                },
                {
                  ...
                  description: 'An agent with this ID already exists (main or sub).',
                  template: '',
                },
                {
                  ...
                  description: 'The referenced modelId does not exist in the model library.',
                  template: '',
                },
              ],
              examples: [],
            ...
            },
            {
              ...
              schema: 'input SetSubAgentNameInput {\n  id: OID!\n  name: String!\n}',
            ...
            },
            {
              ...
              schema: 'input SetSubAgentDescriptionInput {\n  id: OID!\n  description: String!\n}',
        ...
        },
        {
          ...
          description: 'Per-agent assignments of model, profile references, skills, and tool-name patterns. agentId resolves to main if it matches mainAgent.id, else looks up subAgents.',
          operations: [
            {
              id: 'o-set-agent-model',
              name: 'SET_AGENT_MODEL',
              description: "Set the agent's model. modelId must exist in the model library. agentId resolves to main or a sub.",
              schema: 'input SetAgentModelInput {\n  agentId: OID!\n  modelId: OID!\n}',
              ...
              errors: [
                {
                  ...
                  name: 'MastraNotEnabledError',
                  code: 'MASTRA_NOT_ENABLED',
                  description: 'Mastra must be enabled before managing agent bindings.',
                  template: '',
                },
                {
                  ...
                  name: 'AgentNotFoundError',
                  code: 'AGENT_NOT_FOUND',
                  description: 'The specified agentId resolves to neither main nor any sub-agent.',
                  template: '',
                },
                {
            ...
            },
            {
              ...
              description: 'Add a profile reference to an agent. profileId must exist in the profile library. Inserts before insertBefore if provided, otherwise appends. Dedup: silent if already present.',
              schema: 'input AddAgentProfileRefInput {\n  agentId: OID!\n  profileId: OID!\n  insertBefore: OID\n}',
              ...
              errors: [
                ...
                },
                {
                  ...
                  description: 'The referenced profileId does not exist in the profile library, or insertBefore is not present in the agent.',
                  template: '',
                },
              ],
              examples: [],
            ...
            },
            {
              ...
              schema: 'input RemoveAgentProfileRefInput {\n  agentId: OID!\n  profileId: OID!\n}',
              ...
              errors: [
                ...
                },
                {
                  ...
                  name: 'ProfileReferenceNotFoundError',
                  code: 'PROFILE_REFERENCE_NOT_FOUND',
                  description: "The profileId is not present in this agent's profileIds.",
                  template: '',
                },
              ],
              examples: [],
            ...
            },
            {
              ...
              description: "Reorder an agent's profile references. Moves the given ids before insertBefore, or to the end if insertBefore is null.",
              schema: 'input ReorderAgentProfileRefsInput {\n  agentId: OID!\n  ids: [OID!]!\n  insertBefore: OID\n}',
              ...
              errors: [
                ...
                },
                {
                  ...
                  name: 'ProfileReferenceNotFoundError',
                  code: 'PROFILE_REFERENCE_NOT_FOUND',
                  description: 'A referenced profileId is not present in this agent.',
                  template: '',
                },
              ],
              examples: [],
            ...
            },
            {
              ...
              description: 'Add a skill name to an agent. Dedup: silent if already present.',
              schema: 'input AddAgentSkillInput {\n  agentId: OID!\n  name: String!\n}',
            ...
            },
            {
              ...
              schema: 'input RemoveAgentSkillInput {\n  agentId: OID!\n  name: String!\n}',
            ...
            },
            {
              ...
              description: 'Add a tool-name glob pattern to an agent. Dedup: silent if already present.',
              schema: 'input AddAgentToolPatternInput {\n  agentId: OID!\n  pattern: String!\n}',
            ...
            },
            {
              ...
              schema: 'input RemoveAgentToolPatternInput {\n  agentId: OID!\n  pattern: String!\n}',
