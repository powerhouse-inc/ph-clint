...
## DM.00.2 Use the reactor project management tools to run Vetra Connect and Switchboard
...
- Request the Vetra Connect, Switchboard and MCP endpoints using `{{commands.reactor-project-ps.id}}`
