...
- Once the project is running, verify that the `vetra-mcp__*` tools are available and responsive
- Request the Vetra drive through the `vetra-mcp__*` tools and verify you can see it.
...
- Request the Vetra Connect, Switchboard and MCP endpoints using `vetra-ps`
