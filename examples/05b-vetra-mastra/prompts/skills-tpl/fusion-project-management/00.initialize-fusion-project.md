...
- Use the `{{commands.fusion-projects-list.id}}` tool to get all existing Fusion projects
...
- Use `{{commands.fusion-projects-list.id}}` to confirm the new project appears in the list and see its status