...
- Use `reactor-packages-list` and `vetra-start` to ensure the right Reactor Package backend project is running. Spin it up if needed.
- Use `fusion-projects-list` and `fusion-project-start` to ensure the correct Fusion project is running. Spin it up if needed.
