...
- Use `fusion-project-start` with the project name and switchboard URL from steps FPM.01 and FPM.02
...
- The project is ready when Vetra Connect and Switchboard are both running. Use `fusion-project-ps` to get the current status.
