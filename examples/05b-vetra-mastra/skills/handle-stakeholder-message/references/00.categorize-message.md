...
- Use the agent-manager MCP tool to access the manager drive (ID: )

- Open your inbox document (ID: ) through the agent-manager tool and 
  locate the thread with id:  about ""
