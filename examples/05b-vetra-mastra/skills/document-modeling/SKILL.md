...
* **Write Description** [references/01.write-description.md](references/01.write-description.md)
* **Define State And Operations** [references/02.define-state-and-operations.md](references/02.define-state-and-operations.md)
* **Implement Reducers** [references/03.implement-reducers.md](references/03.implement-reducers.md)
* **Expected Outcome** [references/expected-outcome.md](references/expected-outcome.md)
