...
describe("DocumentationOperations", () => {
  ...
  it("should handle updateInstructions operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle clearInstructions operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle markAsDraft operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle markAsReady operation", () => {
    const document = utils.createDocument();
