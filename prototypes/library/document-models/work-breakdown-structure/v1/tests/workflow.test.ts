...
describe("WorkflowOperations", () => {
  ...
  it("should handle delegateGoal operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle reportOnGoal operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle markInProgress operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle markTodo operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle reportBlocked operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle unblockGoal operation", () => {
    const document = utils.createDocument();
  ...
  it("should handle markWontDo operation", () => {
    const document = utils.createDocument();
...
describe("Workflow Operations - Behavioral Tests", () => {
  describe("CREATE_GOAL", () => {
    ...
    it("should create complex hierarchy with multiple levels", () => {
      ...
      const child = document.state.global.goals.find(
        (g) => g.id === "child-1",
      );
