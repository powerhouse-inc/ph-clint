...
export const errors = {
  DeleteSlide: { SlideNotFoundError },
  DuplicateSlide: { SlideNotFoundError },
  ReorderSlides: { SlideNotFoundError },
  SetSlideTemplate: { SlideNotFoundError },
  UpdateSlideContent: { SlideNotFoundError },
};
