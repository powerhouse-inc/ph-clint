...
export function BulletColumnSchema(): z.ZodObject<Properties<BulletColumn>> {
  return z.object({
    ...
    bulletItems: z.array(z.lazy(() => TextItemSchema())),
    title: z.string().nullish(),
  });
}
...
export function SlideSchema(): z.ZodObject<Properties<Slide>> {
  return z.object({
    ...
    agendaItems: z.array(z.lazy(() => AgendaItemSchema())),
    bigNumber: z.string().nullish(),
    bulletItems: z.array(z.lazy(() => TextItemSchema())),
    checklistItems: z.array(z.lazy(() => ChecklistItemSchema())),
    codeContent: z.string().nullish(),
    columns: z.array(z.lazy(() => BulletColumnSchema())),
    description: z.string().nullish(),
    footerLeft: z.string().nullish(),
    footerRight: z.string().nullish(),
    highlights: z.array(z.lazy(() => HighlightItemSchema())),
    iconListItems: z.array(z.lazy(() => IconListItemSchema())),
    id: z.string(),
    imageUrl: z.string().nullish(),
    leftText: z.string().nullish(),
    leftTitle: z.string().nullish(),
    links: z.array(z.lazy(() => LinkSchema())),
    milestones: z.array(z.lazy(() => MilestoneItemSchema())),
    processSteps: z.array(z.lazy(() => ProcessStepSchema())),
    ...
    steps: z.array(z.lazy(() => TextItemSchema())),
