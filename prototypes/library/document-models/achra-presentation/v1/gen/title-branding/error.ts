...
export const errors = {
  AddLink: { SlideNotFoundError },
  UpdateLink: { SlideNotFoundError, ItemNotFoundError },
  DeleteLink: { SlideNotFoundError, ItemNotFoundError },
  ReorderLinks: { SlideNotFoundError, ItemNotFoundError },
};
